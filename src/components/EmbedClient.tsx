    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="flex justify-center px-4 py-14">
        ...
        >
          ...
          <p>
            Copy and Pase this code before <code>&lt;/body&gt;</code>
          </p>
          <div className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10 mt-5">
          ...
          <ol className="space-y-3 text-sm text-zinc-600 list-decimal list-inside">
            ...
            <div className="mt-14">
              ...
              <div className="rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden">
                ...
                <div
                className="absolute bottom-24 right-6 w-64 bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden">
                  ...
                  <div className="p-3 space-y-2 bg-zinc-50">
                    <div className="bg-zinc-200 text-zinc-800 text-xs px-3 py-2 rounded-lg w-fit">Hhello ! how can I help you?</div>
                ...
                className="absolute bottom-6 right-6 w-12 h-12 rounded-full bg-black text-white flex items-center justify-center shadow-2xl cursor-pointer"
